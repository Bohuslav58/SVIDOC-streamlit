...
st.title('conversion scan copy of invoices to isdoc format')

st.write('Download selected files, and then click on convert')
uploaded_files=st.file_uploader('Choose invoices to be converted to isdoc format:', accept_multiple_files=True)
